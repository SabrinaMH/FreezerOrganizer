...
namespace UnitTests
{
    ...
    public class ItemTests
    {
        ...
        {
            Item item = new Item("item", 5, Item.Units.bag, new DateTime(2014, 10, 30, 1, 1, 1));
            Item sameItem = new Item("item", 5, Item.Units.bag, new DateTime(2014, 10, 30, 2, 2, 2));
            Item differentNameItem = new Item("another item", 5, Item.Units.bag, new DateTime(2014, 10, 30));
            Item differentNumberItem = new Item("item", 3, Item.Units.bag, new DateTime(2014, 10, 30));
            Item differentDateItem = new Item("item", 5, Item.Units.bag, new DateTime(2013, 10, 30));
        ...
        {
            Item item = new Item("item", 2, Item.Units.bag, DateTime.Today);
            int extraItems = 10;
